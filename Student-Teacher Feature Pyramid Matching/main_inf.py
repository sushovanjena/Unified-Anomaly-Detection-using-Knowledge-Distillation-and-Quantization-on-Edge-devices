...
def main():
    ...
    if args.split == 'train':
        ...
        for i, category in enumerate(args.category):
            ...
            with open('output_stfpm.txt', 'a') as f:
                f.write(f'Catergory: {category}\tPixel-AUC: {auc_pixel}\tImage-AUC: {auc_image_max}\tPRO: {pro}'.format(category, auc_pixel, auc_image_max, pro)+' '+'\n')
